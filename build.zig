...
pub fn build(b: *std.Build) void {
    ...
    const mod = b.addModule("ros_observer", .{
        ...
        // the root file.
        .root_source_file = b.path("src/root.zig"), // Later on we'll use this module as the root module of a test executable
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "ros_observer" is the name you will use in your source code to
                // import this module (e.g. `@import("ros_observer")`). The name is
